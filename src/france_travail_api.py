...
# Filtre local (au cas où certaines requêtes récupèrent du bruit)
DATA_AI_KEYWORDS_REGEX = re.compile(
    ...
    r"business\s*intelligence|\bbi\b|décisionnel|"
...
class FranceTravailClient:
    ...
    # ============================================================
    # BULK: récupérer plusieurs pages via Range (0-149, 150-299...)
    # ============================================================
    def search_all(
        self,
        params: Optional[Dict[str, Any]] = None,
    ...
    # ============================================================
    # COLLECT Data & IA : multi-queries + detail + dédup + filtre
    # ============================================================
