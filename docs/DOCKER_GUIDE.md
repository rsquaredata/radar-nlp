...
class ETLPipeline:
    ...
    def load(self, df: pd.DataFrame):
        ...
        print(f"⚠️ {self.stats['offers_duplicates']:,} doublons ignorés")
...
def premium_navbar(active_page: str):
    ...
    pages = {
        ...
        "🗺️ Géographie": "pages/Geographie.py",
...
# 2. Cloner votre fork
git clone https://github.com/VOTRE_USERNAME/radar-nlp.git
cd radar-nlp
...
Développé avec ❤️ par l'équipe R²
